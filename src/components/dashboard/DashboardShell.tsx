...
export default function DashboardShell({ children, userEmail, userName, userHandle, avatarUrl }: DashboardLayoutProps) {
  ...
  const navItems: NavItem[] = [
    ...
    },
    {
      ...
      icon: (
        <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11 3h2m-7 4h12M7 7l-2 12h14L17 7M9 11h6m-6 4h6"></path></svg>
      ),
      children: [
        {
        ...
        },
        {
          ...
          icon: <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>,
        },
        {
          name: 'e-Billing',
          href: '/dashboard/billing',
          icon: <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 14h6m-6-4h6m-7 10h8a2 2 0 002-2V6.414a1 1 0 00-.293-.707l-2.414-2.414A1 1 0 0014.586 3H8a2 2 0 00-2 2v13a2 2 0 002 2z"></path></svg>,
        },
      ],
    },
    {
                  ...
                  <div className="border-b border-slate-900 pb-3">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <button
                        ...
                        onClick={(event) => event.preventDefault()}
                        className="flex items-center gap-2.5 w-full px-3 py-2 text-xs font-semibold text-slate-300 rounded-lg cursor-default"
                        aria-label="Total XP yang dikumpulkan"
                      >
